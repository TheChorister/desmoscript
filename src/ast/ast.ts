import { Result, err, ok } from "../compiler-errors.ts";
import { MacroAPI } from "../macro/macro-api.ts";
import { DSType } from "../scope-tree/typecheck/typecheck.ts";
import { BuiltinTypeSignature } from "../stdlib/stdlib.ts";
